        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {capabilities.map((capability, index) => {
            ...
            return (
              ...
              >
                {/* Card */}
                <div className="relative p-8 rounded-2xl bg-white/80 backdrop-blur-sm border border-brand-purple/10 h-full transition-all duration-300 hover:shadow-2xl hover:shadow-brand-purple/10 overflow-hidden">
                  {/* Animated top border */}
                  <div
                  ...
                  {/* Content */}
                  <h3 className="text-xl font-semibold text-foreground mb-3 transition-all duration-300 group-hover:bg-gradient-to-r group-hover:from-brand-magenta group-hover:via-brand-purple group-hover:to-brand-blue group-hover:bg-clip-text group-hover:text-transparent">
                    {capability.title}
                  </h3>
