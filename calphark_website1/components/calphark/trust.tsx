        ...
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          >
            ...
            <div className="space-y-4">
              {certifications.map((cert, index) => (
                <div
                  key={cert}
                  className={`group flex items-center gap-3 transition-all duration-500 cursor-pointer ${
                    isVisible
                ...
                >
                  <div className="w-6 h-6 rounded-full bg-gradient-to-br from-brand-magenta/10 via-brand-purple/10 to-brand-blue/10 flex items-center justify-center transition-all duration-300 group-hover:from-brand-magenta/20 group-hover:via-brand-purple/20 group-hover:to-brand-blue/20 group-hover:scale-110">
                    <CheckCircle2 className="w-4 h-4 text-brand-purple transition-colors group-hover:text-brand-magenta" />
                  </div>
          ...
          >
            {stats.map((stat, index) => (
              <div
                key={stat.label}
                className="group relative p-8 rounded-2xl bg-white/80 backdrop-blur-sm border border-brand-purple/10 text-center transition-all duration-300 hover:shadow-xl hover:shadow-brand-purple/10 overflow-hidden"
              >
                {/* Animated background */}
